...
The goal of plavaan is to perform penalized estimation for latent variable models using lavaan with a differentiable penalty function, as described in [Robitzsch (2023)](https://www.mdpi.com/1999-4893/16/9/446) and similar to the approach described in [Asparouhov & Muthén (2024)](https://www.statmodel.com/download/PML.pdf).
